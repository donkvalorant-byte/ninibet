    ...
    <main className="min-h-screen text-white relative overflow-hidden">
      ...
      <style jsx global>{`
        .auth-bg {
          ...
          inset: 0;
          background:
            radial-gradient(circle at 15% 20%, rgba(255, 0, 180, 0.55), transparent 42%),
            radial-gradient(circle at 85% 30%, rgba(255, 80, 220, 0.45), transparent 48%),
            radial-gradient(circle at 50% 85%, rgba(255, 0, 150, 0.60), transparent 54%),
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 text-3xl font-extrabold">
                <span className="rainbowTitle">Kayıt Ol</span>
              </h1>
              <p className="mt-2 text-sm text-white/70">Yeni hesap aç, bakiyeni admin versin 😄</p>
            </div>
          ...
          <div className="mt-6 space-y-3">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Kullanıcı adı (min 3)"
                value={username}
